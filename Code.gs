...
var eeUserName = Session.getEffectiveUser();                                             // R
var eeinfo ="MERGE";                                                                     // 
var eedetails ="7.9 Copy cells to populate sheet";                                           // L
var eeStatus="Started";                                                                  // O
var fName = arguments.callee.toString().match(/function ([^\(]+)/)[1]                    // G
var eeSheetName = "MERGE";                                                               //
var values = [                                                                           // S
...
//=vlookup($B3,APPDATA!$A:$F,6,false)"
...
sheet.getRange("D3:H1000").copyTo(sheet.getRange("D3"), {contentsOnly:true});
//Browser.msgBox("AFTER ADD");
//////////////////////////////////////////////////////break;
